...
<h3 class="m-3" style="margin-left: 20px"> Add new product</h3>
...
<form class="m-2" style="margin-left: 20px" action="?action=create" method="post">
    ...
    <div class="form-group m-2">
        ...
        <input name="description" type="text" class="form-control" id="description" placeholder="Enter desctiption">
    </div>
    <div class="form-group m-2">
    ...
    <div class="form-group m-2" style="margin-top: 20px">
        <button type="submit" class="btn btn-success">Create</button>
        <a href="/products" class="btn btn-secondary active" role="button" aria-pressed="true">Back</a>
    </div>
</form>
</body>
</html>
